...
# DETERMINE HOW LONG TO WAIT BEFORE THE NEXT IMAGE IS SERVED IN SECONDS
$waitTime = 60;

# HOW LONG TO WAIT AFTER IMAGE BEGINS LOADING TO FTP SERVER FROM AMCREST CAMERA BEFORE WE LET THE USER SEE IT IN SECONDS
$howLongToWait = 6;
